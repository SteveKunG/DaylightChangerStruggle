...
public class TextFieldWidgetConfig extends EditBox implements WidgetConfigInterface<StringValue, String>, PositionedTooltip
{
    String initialText;
    ...
    public TextFieldWidgetConfig(Font textRenderer, int width, int height, StringValue property, boolean allowEmptyText)
    {
    ...
    public void forceSetWidgetValueToDefault(boolean justInitial)
    {
        ...
        {
            var def = this.property.getDefaultValue();
