...
//        }
    ...
    public void writePropertyValueToCycle(BaseProperty<?, ?> property)
    {
        ...
        if (property instanceof LongValue)
        {
            ...
            {
                case "minHeightTime":
                    this.minHeightTime = prop.get();
                    break;
                case "maxHeightTime":
                    this.maxHeightTime = prop.get();
                    break;
            }
        }
        else if (property instanceof DoubleValue)
        {
            ...
            {
                case "minHeight":
                    this.minHeight = prop.get();
                    break;
                case "maxHeight":
                    this.maxHeight = prop.get();
                    break;
            }
        }
    }
    ...
    public static class Builder implements DayNightCycleBuilder
    {
        ...
        {
            return Component.translatable("jugglestruggle.tcs.dnt.lowtohighheighttime");
        }

        @Override
        public Component getTranslatableDescription()
        {
            return Component.translatable("jugglestruggle.tcs.dnt.lowtohighheighttime.description");
        }
