...
public abstract class BaseNumber<N extends Number> extends BaseProperty<BaseNumber<N>, N>
{
    ...
    public void readFromJson(JsonElement elem)
    {
        ...
        if (prim.isNumber())
        {
            var n = prim.getAsNumber();

            var expectedNumber = n.getClass().equals(this.getDefaultValue().getClass());
    ...
    public JsonElement writeToJson()
    {
        ...
        return new JsonPrimitive(value == null ? this.getDefaultValue() : value);
    }
