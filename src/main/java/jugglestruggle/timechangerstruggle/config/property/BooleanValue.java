...
public class BooleanValue extends BaseProperty<BooleanValue, Boolean>
{
    ...
    @Override
    public WidgetConfigInterface<BooleanValue, Boolean> createConfigElement(TimeChangerScreen screen, FancySectionProperty owningSection)
    {
        var builder = CyclingWidgetConfig.booleanCycle(this, this.trueText, this.falseText);
